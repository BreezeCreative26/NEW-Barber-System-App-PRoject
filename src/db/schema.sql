...
-- Shared availability checks for insert and reschedule. The shop may force past the roster and
-- overlap checks (Fresha-style double booking) via a transaction-local flag; see 0010.
