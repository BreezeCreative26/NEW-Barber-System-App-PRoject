...
Version 1.4 · 2026-09-14. **Latest connected-calendar verification: 42 unit/route/domain tests, direct D1 invariants and 60 browser/API cases passed on unchanged source.** Added complete >500-record day/impact reads, cursor ties and tenant/query validation, timetable click/create/reload/move/cancel, preserved multi-row pricing drafts, explicit dialog discard, response recovery and 390/1440 timetable checks. Existing five-width/fixture regressions retained. See PROGRESS for final 13:24 UTC report and remaining gaps. T-ENH contracts below remain broader than this delivery: no full role/provider/device acceptance is claimed.
