...
3. **WP-002-A/B — Complete setup and production identity separately.** Basic saved shop/staff/services/hours screens exist in WP-LOCAL-01. Full-day staff leave is implemented locally. Complete add-ons, staff coverage/overrides and partial-day time overrides next. Managed authentication, memberships, MFA and invitation lifecycle remain explicit production gates; provider selection does not block local functional work.
